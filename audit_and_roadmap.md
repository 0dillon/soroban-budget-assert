...
- [x] **Demo Video**: Linked in the README — an asciinema recording showing a contract exceeding its budget and failing, followed by a passing assertion (`README.md:10`).
...
- [x] Record a short demo video showing a contract exceeding its budget and failing, followed by a passing assertion. — Linked at `README.md:10` (`https://asciinema.org/a/qqC0RysuCDBvfUXC`).
